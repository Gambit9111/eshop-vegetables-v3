...
const Footer = () => {
  return (
    <>
      {/* mobile screen */}
      <footer className="h-full bg-myGreen text-myWhite xl:hidden">
      ...
      {/* desktop screen */}
      <footer className="hidden flex-col bg-myGreen xl:flex">
        <div className="flex h-full w-full items-center justify-between text-myWhite">
          <div className="pl-32 pt-6 pb-3">
            <h1 className="font-Cinzel text-4xl font-bold text-myYellow">
              Logo
            </h1>
            ...
            <div className="pt-6">
              <p className="pr-32 font-Poppins text-sm">
                Iveskite savo el. paštą, kad gauti naujausius pasiūlymus
              </p>
              <div className="flex w-full items-center justify-center">
                <input
                  className="mt-1 h-9 w-full rounded-tl rounded-bl border border-myWhite/50 bg-myGreen"
                  type="email"
                />
                <button className="mt-1 h-9 w-32 rounded-tr rounded-br bg-myWhite font-Poppins font-semibold text-myBlack">
                  Prisijungti
                </button>
              </div>
            </div>
            <div className="mt-6 flex items-center justify-start gap-6">
              ...
              <Image src={twitch} alt={twitch} className="w-8" />
              <Image src={instagram} alt={instagram} className="w-8" />
              <Image src={pinterest} alt={pinterest} className="w-8" />
            </div>
          </div>
          <div className="flex justify-between gap-16 pt-8 pr-32 font-Poppins text-myWhite/50">
            <div className="space-y-1">
              <h3 className="pb-1 uppercase text-myWhite">Informacija</h3>
              <h4>Dovanos</h4>
              <h4>Tapk partneriu</h4>
        ...
        <div className="my-3 h-[1px] w-full bg-myWhite/50" />
        <h5 className="px-6 pb-3 text-center font-Cinzel text-xs font-bold uppercase tracking-wider text-myYellow/30">
          2023Ⓡ Gucci Gang{" "}
        </h5>
      </footer>
    </>
